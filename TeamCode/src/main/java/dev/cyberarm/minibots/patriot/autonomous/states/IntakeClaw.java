...
public class IntakeClaw extends CyberarmState {
    private final MinibotPatriotRobot robot;
    private final String groupName, actionName;

    private final int timeoutMS;
    private final boolean openClaw;
    public IntakeClaw(MinibotPatriotRobot robot, String groupName, String actionName) {
        this.robot = robot;
    ...
    @Override
    public void start() {
        robot.positionClaw(openClaw ? HardwareState.INTAKE_CLAW_OPEN : HardwareState.INTAKE_CLAW_CLOSED);
    }
